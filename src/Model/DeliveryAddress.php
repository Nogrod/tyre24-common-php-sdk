...
class DeliveryAddress implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DeliveryAddress';
    ...
    protected static array $openAPITypes = [
        ...
        'price' => '\Tyre24\Common\Model\Price'
    ];
    ...
    protected static array $setters = [
        'use_alternative_address' => 'setUseAlternativeAddress',
        'address' => 'setAddress',
        'contact' => 'setContact',
        'price' => 'setPrice'
    ];
    ...
    protected static array $getters = [
        'use_alternative_address' => 'getUseAlternativeAddress',
        'address' => 'getAddress',
        'contact' => 'getContact',
        'price' => 'getPrice'
    ];
    ...
    {
        $this->setIfExists('use_alternative_address', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['use_alternative_address'] === null) {
            $invalidProperties[] = "'use_alternative_address' can't be null";
        }
    ...
    /**
     * Gets use_alternative_address
     *
     * @return bool
     */
    public function getUseAlternativeAddress(): bool
    {
        return $this->container['use_alternative_address'];
    }

    /**
     * Sets use_alternative_address
     *
     * @param bool $use_alternative_address True if alternative delivery address is used, otherwise false
     *
     * @return $this
     */
    public function setUseAlternativeAddress(bool $use_alternative_address): static
    {
        if (is_null($use_alternative_address)) {
            throw new InvalidArgumentException('non-nullable use_alternative_address cannot be null');
        }
        $this->container['use_alternative_address'] = $use_alternative_address;
     ...
     * Sets address
     *
     * @param \Tyre24\Common\Model\Address|null $address Delivery address
     *
     * @return $this
     */
     ...
     * Sets contact
     *
     * @param \Tyre24\Common\Model\Contact|null $contact Contact of the recipient
     *
     * @return $this
     */
     ...
     */
    public function getPrice(): ?\Tyre24\Common\Model\Price
    {
     ...
     * Sets price
     *
     * @param \Tyre24\Common\Model\Price|null $price Additional costs for delivery address
     *
     * @return $this
     */
    public function setPrice(?\Tyre24\Common\Model\Price $price): static
    {
        if (is_null($price)) {
