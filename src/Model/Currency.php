...
class Currency implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $setters = [
        'code_origin' => 'setCodeOrigin',
        'code_converted' => 'setCodeConverted',
        'factor' => 'setFactor'
    ];
    ...
    protected static array $getters = [
        'code_origin' => 'getCodeOrigin',
        'code_converted' => 'getCodeConverted',
        'factor' => 'getFactor'
    ];
    ...
    {
        $this->setIfExists('code_origin', $data ?? [], null);
        $this->setIfExists('code_converted', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['code_origin'] === null) {
            $invalidProperties[] = "'code_origin' can't be null";
        }
        if ($this->container['code_converted'] === null) {
            $invalidProperties[] = "'code_converted' can't be null";
        }
    ...
    {
        return $this->container['code_origin'];
    }

    /**
     * Sets code_origin
     *
     * @param string $code_origin Currency code of the origin price
     *
     * @return $this
     */
    public function setCodeOrigin(string $code_origin): static
    {
        if (is_null($code_origin)) {
            throw new InvalidArgumentException('non-nullable code_origin cannot be null');
        }
        $this->container['code_origin'] = $code_origin;
     ...
     * @return string
     */
    public function getCodeConverted(): string
    {
        return $this->container['code_converted'];
    }

    /**
     * Sets code_converted
     *
     * @param string $code_converted Currency code of the converted price
     *
     * @return $this
     */
    public function setCodeConverted(string $code_converted): static
    {
        if (is_null($code_converted)) {
            throw new InvalidArgumentException('non-nullable code_converted cannot be null');
        }
        $this->container['code_converted'] = $code_converted;
     ...
     * Sets factor
     *
     * @param float $factor The factor to convert prices from origin to converted currency
     *
     * @return $this
     */
