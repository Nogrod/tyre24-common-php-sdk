...
class LoginUser200Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'loginUser_200_response';
    ...
    protected static array $openAPITypes = [
        'data' => '\Tyre24\Common\Model\LoginToken'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Tyre24\Common\Model\LoginToken|null
     */
    public function getData(): ?\Tyre24\Common\Model\LoginToken
    {
     ...
     * Sets data
     *
     * @param \Tyre24\Common\Model\LoginToken|null $data data
     *
     * @return $this
     */
    public function setData(?\Tyre24\Common\Model\LoginToken $data): static
    {
        if (is_null($data)) {
