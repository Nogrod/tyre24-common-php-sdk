...
/**
 * ContactLatest Class Doc Comment
 *
 * @package  Tyre24\Common
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ContactLatest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ContactLatest';
    ...
    */
     ...
     * Sets email
     *
     * @param string|null $email Link to the contact page.
     *
     * @return $this
     */
     ...
     * Sets firstname
     *
     * @param string|null $firstname Fristname of the contact
     *
     * @return $this
     */
     ...
     * Sets lastname
     *
     * @param string|null $lastname Lastname of the contact
     *
     * @return $this
     */
