 ...
 */
class CheckOption implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CheckOption';
    ...
    */
     ...
     * Sets key
     *
     * @param string $key Contains the name of the check option
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param string $value Contains the value of the check option
     *
     * @return $this
     */
