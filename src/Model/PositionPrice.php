...
/**
 * PositionPrice Class Doc Comment
 *
 * @package  Tyre24\Common
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PositionPrice implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PositionPrice';
    ...
    protected static array $setters = [
        'net_original' => 'setNetOriginal',
        'vat' => 'setVat',
        'net' => 'setNet',
        'net_converted' => 'setNetConverted',
        'gross' => 'setGross',
        'gross_converted' => 'setGrossConverted'
    ];
    ...
    protected static array $getters = [
        'net_original' => 'getNetOriginal',
        'vat' => 'getVat',
        'net' => 'getNet',
        'net_converted' => 'getNetConverted',
        'gross' => 'getGross',
        'gross_converted' => 'getGrossConverted'
    ];
    ...
    {
        $this->setIfExists('net_original', $data ?? [], null);
        $this->setIfExists('vat', $data ?? [], null);
        $this->setIfExists('net', $data ?? [], null);
        $this->setIfExists('net_converted', $data ?? [], null);
        $this->setIfExists('gross', $data ?? [], null);
        $this->setIfExists('gross_converted', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['net_converted'] === null) {
            $invalidProperties[] = "'net_converted' can't be null";
        }
     ...
     * @return float|null
     */
    public function getNetOriginal(): ?float
    {
        return $this->container['net_original'];
    }

    /**
     * Sets net_original
     *
     * @param float|null $net_original Contains the original imported net value of the price (will only be displayed for sellers)
     *
     * @return $this
     */
    public function setNetOriginal(?float $net_original): static
    {
        if (is_null($net_original)) {
            throw new InvalidArgumentException('non-nullable net_original cannot be null');
        }
        $this->container['net_original'] = $net_original;
     ...
     * Sets vat
     *
     * @param float|null $vat Contains the value-added tax (VAT) the price has been calculated with
     *
     * @return $this
     */
     ...
     * Sets net
     *
     * @param float $net Contains the net value of the price
     *
     * @return $this
     */
     ...
     * @return float
     */
    public function getNetConverted(): float
    {
        return $this->container['net_converted'];
    }

    /**
     * Sets net_converted
     *
     * @param float $net_converted Contains the net value of the price converted to the given currency
     *
     * @return $this
     */
    public function setNetConverted(float $net_converted): static
    {
        if (is_null($net_converted)) {
            throw new InvalidArgumentException('non-nullable net_converted cannot be null');
        }
        $this->container['net_converted'] = $net_converted;
     ...
     * Sets gross
     *
     * @param float|null $gross Contains the gross value of the net value
     *
     * @return $this
     */
    ...
    /**
     * Gets gross_converted
     *
     * @return float|null
     */
    public function getGrossConverted(): ?float
    {
        return $this->container['gross_converted'];
    }

    /**
     * Sets gross_converted
     *
     * @param float|null $gross_converted Contains the gross value of the net converted value to the given currency
     *
     * @return $this
     */
    public function setGrossConverted(?float $gross_converted): static
    {
        if (is_null($gross_converted)) {
            throw new InvalidArgumentException('non-nullable gross_converted cannot be null');
        }
        $this->container['gross_converted'] = $gross_converted;
