...
/**
 * GetAvailableArticleTypesListFilterParameterInner Class Doc Comment
 *
 * @package  Tyre24\Common
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetAvailableArticleTypesListFilterParameterInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getAvailableArticleTypesList_filter_parameter_inner';
    ...
    protected static array $attributeMap = [
        'type' => 'type',
        'key' => 'key',
        'active_in_year' => 'activeInYear',
        'once_active' => 'onceActive'
    ];
    ...
    protected static array $setters = [
        'type' => 'setType',
        'key' => 'setKey',
        'active_in_year' => 'setActiveInYear',
        'once_active' => 'setOnceActive'
    ];
    ...
    protected static array $getters = [
        'type' => 'getType',
        'key' => 'getKey',
        'active_in_year' => 'getActiveInYear',
        'once_active' => 'getOnceActive'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('active_in_year', $data ?? [], null);
        $this->setIfExists('once_active', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Filter the result set by article type.  Allowed operators are:  | operator | example | | ------ | ------ | | `eq` | `eq;1337` | | `neq` | `neq;42` | | `gt` | `gt;69` | | `gte` | `gte;99` | | `lt` | `lt;69` | | `lte` | `lte;99` | | `in` | `in;1,2,3` | | `nin` | `nin;4,5,6` | | `wc` | `wc;j**n** doe` | | `nwc` | `nwc;john` | | `btw` | `btw;10,20` | | `rxp` | `rxp;j(oh\\|a)ne?` | | `null` | `null;` | | `nnull` | `nnull;` |
     *
     * @return $this
     */
     ...
     * Sets key
     *
     * @param string|null $key Filter the result set by article key.  Allowed operators are:  | operator | example | | ------ | ------ | | `eq` | `eq;1337` | | `neq` | `neq;42` | | `gt` | `gt;69` | | `gte` | `gte;99` | | `lt` | `lt;69` | | `lte` | `lte;99` | | `in` | `in;1,2,3` | | `nin` | `nin;4,5,6` | | `wc` | `wc;j**n** doe` | | `nwc` | `nwc;john` | | `btw` | `btw;10,20` | | `rxp` | `rxp;j(oh\\|a)ne?` | | `null` | `null;` | | `nnull` | `nnull;` |
     *
     * @return $this
     */
     ...
     * @return string|null
     */
    public function getActiveInYear(): ?string
    {
        return $this->container['active_in_year'];
    }

    /**
     * Sets active_in_year
     *
     * @param string|null $active_in_year Filter the result set by activation year.  Allowed operators are:  | operator | example | | ------ | ------ | | `eq` | `eq;1337` | | `neq` | `neq;42` | | `gt` | `gt;69` | | `gte` | `gte;99` | | `lt` | `lt;69` | | `lte` | `lte;99` | | `in` | `in;1,2,3` | | `nin` | `nin;4,5,6` | | `wc` | `wc;j**n** doe` | | `nwc` | `nwc;john` | | `btw` | `btw;10,20` | | `rxp` | `rxp;j(oh\\|a)ne?` | | `null` | `null;` | | `nnull` | `nnull;` |
     *
     * @return $this
     */
    public function setActiveInYear(?string $active_in_year): static
    {
        if (is_null($active_in_year)) {
            throw new InvalidArgumentException('non-nullable active_in_year cannot be null');
        }
        $this->container['active_in_year'] = $active_in_year;
     ...
     * @return string|null
     */
    public function getOnceActive(): ?string
    {
        return $this->container['once_active'];
    }

    /**
     * Sets once_active
     *
     * @param string|null $once_active Filter the result set by active article type.  Allowed operators are:  | operator | example | | ------ | ------ | | `eq` | `eq;1337` | | `neq` | `neq;42` | | `gt` | `gt;69` | | `gte` | `gte;99` | | `lt` | `lt;69` | | `lte` | `lte;99` | | `in` | `in;1,2,3` | | `nin` | `nin;4,5,6` | | `wc` | `wc;j**n** doe` | | `nwc` | `nwc;john` | | `btw` | `btw;10,20` | | `rxp` | `rxp;j(oh\\|a)ne?` | | `null` | `null;` | | `nnull` | `nnull;` |
     *
     * @return $this
     */
    public function setOnceActive(?string $once_active): static
    {
        if (is_null($once_active)) {
            throw new InvalidArgumentException('non-nullable once_active cannot be null');
        }
        $this->container['once_active'] = $once_active;
