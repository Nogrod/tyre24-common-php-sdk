...
/**
 * GetDocumentsByTypeAndIdFilterParameterInner
 *
 * PHP version 8.1
 *
...
/**
 * GetDocumentsByTypeAndIdFilterParameterInner Class Doc Comment
 *
 * @package  Tyre24\Common
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetDocumentsByTypeAndIdFilterParameterInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getDocumentsByTypeAndId_filter_parameter_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Filter for a specific document id.  Allowed operators are:  | operator | example | | ------ | ------ | | `eq` | `eq;1337` | | `neq` | `neq;42` | | `gt` | `gt;69` | | `gte` | `gte;99` | | `lt` | `lt;69` | | `lte` | `lte;99` | | `btw` | `btw;10,20` | | `in` | `in;1,2,3` | | `nin` | `nin;4,5,6` |
     *
     * @return $this
     */
     ...
     * Sets retailer_id
     *
     * @param int|null $retailer_id Filter for documents of a specific retailer.  Allowed operators are:  | operator | example | | ------ | ------ | | `eq` | `eq;1337` | | `neq` | `neq;42` | | `gt` | `gt;69` | | `gte` | `gte;99` | | `lt` | `lt;69` | | `lte` | `lte;99` | | `btw` | `btw;10,20` | | `in` | `in;1,2,3` | | `nin` | `nin;4,5,6` |
     *
     * @return $this
     */
    public function setRetailerId(?int $retailer_id): static
    {
     ...
     * Sets supplier_id
     *
     * @param int|null $supplier_id Filter for documents of a specific supplier.  Allowed operators are:  | operator | example | | ------ | ------ | | `eq` | `eq;1337` | | `neq` | `neq;42` | | `gt` | `gt;69` | | `gte` | `gte;99` | | `lt` | `lt;69` | | `lte` | `lte;99` | | `btw` | `btw;10,20` | | `in` | `in;1,2,3` | | `nin` | `nin;4,5,6` |
     *
     * @return $this
     */
     ...
     * Sets active
     *
     * @param bool|null $active Filter only for active or inactive documents (is either 1 or 0).  Allowed operators are:  | operator | example | | ------ | ------ | | `eq` | `eq;1` | | `neq` | `neq;0` |
     *
     * @return $this
     */
