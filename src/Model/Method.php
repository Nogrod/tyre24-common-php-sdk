 ...
 */
class Method implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Method';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id The unique id of the method
     *
     * @return $this
     */
     ...
     * Sets text
     *
     * @param string $text Additional description specifying the method
     *
     * @return $this
     */
     ...
     * Sets price
     *
     * @param \Tyre24\Common\Model\Price $price The costs of this method (e.g. payment method surname fee)
     *
     * @return $this
     */
