 ...
 */
class LoginToken implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'LoginToken';
    ...
    */
     ...
     * Sets token
     *
     * @param string $token Login token for customer
     *
     * @return $this
     */
     ...
     * Sets expire_date
     *
     * @param string $expire_date Expire date from token
     *
     * @return $this
     */
