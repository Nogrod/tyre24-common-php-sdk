...
class Address implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $setters = [
        'name' => 'setName',
        'name_additional' => 'setNameAdditional',
        'street' => 'setStreet',
        'city' => 'setCity',
        'zip' => 'setZip',
        'country' => 'setCountry'
    ...
    protected static array $getters = [
        'name' => 'getName',
        'name_additional' => 'getNameAdditional',
        'street' => 'getStreet',
        'city' => 'getCity',
        'zip' => 'getZip',
        'country' => 'getCountry'
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('name_additional', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['name_additional'] === null) {
            $invalidProperties[] = "'name_additional' can't be null";
        }
    ...
    /**
     * Gets name_additional
     *
     * @return string
     */
    public function getNameAdditional(): string
    {
        return $this->container['name_additional'];
    }

    /**
     * Sets name_additional
     *
     * @param string $name_additional Name additional
     *
     * @return $this
     */
    public function setNameAdditional(string $name_additional): static
    {
        if (is_null($name_additional)) {
            throw new InvalidArgumentException('non-nullable name_additional cannot be null');
        }
        $this->container['name_additional'] = $name_additional;
