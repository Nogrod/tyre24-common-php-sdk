...
/**
 * GetShippingCompaniesByCountryFilterParameterInner Class Doc Comment
 *
 * @package  Tyre24\Common
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetShippingCompaniesByCountryFilterParameterInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getShippingCompaniesByCountry_filter_parameter_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Filter for a specific shipping company id  Allowed operators are:  | operator | example | | ------ | ------ | | `eq` | `eq;1337` | | `neq` | `neq;42` | | `gt` | `gt;69` | | `gte` | `gte;99` | | `lt` | `lt;69` | | `lte` | `lte;99` | | `btw` | `btw;10,20` | | `in` | `in;1,2,3` | | `nin` | `nin;4,5,6` |
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string|null $name Filter for a specific shipping company name  Allowed operators are:  | operator | example | | ------ | ------ | | `eq` | `eq;john doe` | | `neq` | `neq;doe john` | | `in` | `in;john,jane,doe` | | `nin` | `nin;john,jane,doe` | | `wc` | `wc;j**n** doe` | | `nwc` | `nwc;john` | | `rxp` | `rxp;j(oh\\|a)ne?` |
     *
     * @return $this
     */
