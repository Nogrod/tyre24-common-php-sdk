...
class Invoice implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('has_refund', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['has_refund'] === null) {
            $invalidProperties[] = "'has_refund' can't be null";
        }
     ...
     * Sets has_invoice
     *
     * @param bool $has_invoice True if order has an invoice, otherwise false
     *
     * @return $this
     */
     ...
     * @return bool
     */
    public function getHasRefund(): bool
    {
        return $this->container['has_refund'];
    }

    /**
     * Sets has_refund
     *
     * @param bool $has_refund True if order has a refund, otherwise false
     *
     * @return $this
     */
    public function setHasRefund(bool $has_refund): static
    {
        if (is_null($has_refund)) {
            throw new InvalidArgumentException('non-nullable has_refund cannot be null');
        }
        $this->container['has_refund'] = $has_refund;
     ...
     * Sets sum
     *
     * @param float $sum The total sum of the invoice
     *
     * @return $this
     */
