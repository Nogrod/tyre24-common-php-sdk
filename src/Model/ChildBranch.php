 ...
 */
class ChildBranch implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ChildBranch';
    ...
    protected static array $openAPITypes = [
        'child_branch_order' => 'bool',
        'filiale' => '\Tyre24\Common\Model\BusinessPartner'
    ];
    ...
    protected static array $attributeMap = [
        'child_branch_order' => 'child_branch_order',
        'filiale' => 'filiale'
    ];
    ...
    protected static array $setters = [
        'child_branch_order' => 'setChildBranchOrder',
        'filiale' => 'setFiliale'
    ];
    ...
    protected static array $getters = [
        'child_branch_order' => 'getChildBranchOrder',
        'filiale' => 'getFiliale'
    ];
    ...
    {
        $this->setIfExists('child_branch_order', $data ?? [], null);
        $this->setIfExists('filiale', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['child_branch_order'] === null) {
            $invalidProperties[] = "'child_branch_order' can't be null";
        }
        if ($this->container['filiale'] === null) {
            $invalidProperties[] = "'filiale' can't be null";
        }
    ...
    /**
     * Gets child_branch_order
     *
     * @return bool
     */
    public function getChildBranchOrder(): bool
    {
        return $this->container['child_branch_order'];
    }

    /**
     * Sets child_branch_order
     *
     * @param bool $child_branch_order True if the order was placed by a child branch of the user, otherwise false
     *
     * @return $this
     */
    public function setChildBranchOrder(bool $child_branch_order): static
    {
        if (is_null($child_branch_order)) {
            throw new InvalidArgumentException('non-nullable child_branch_order cannot be null');
        }
        $this->container['child_branch_order'] = $child_branch_order;
     ...
     */
    public function getFiliale(): \Tyre24\Common\Model\BusinessPartner
    {
        return $this->container['filiale'];
    }

    /**
     * Sets filiale
     *
     * @param \Tyre24\Common\Model\BusinessPartner $filiale Filiale information of the child branch that placed the order
     *
     * @return $this
     */
    public function setFiliale(\Tyre24\Common\Model\BusinessPartner $filiale): static
    {
        if (is_null($filiale)) {
            throw new InvalidArgumentException('non-nullable filiale cannot be null');
        }
        $this->container['filiale'] = $filiale;
