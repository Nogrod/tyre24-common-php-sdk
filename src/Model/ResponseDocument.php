 ...
 */
class ResponseDocument implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ResponseDocument';
    ...
    protected static array $openAPITypes = [
        'type' => 'string',
        'document_count' => 'int',
        'documents' => '\Tyre24\Common\Model\ResponseDocumentData[]'
    ];
    ...
    */
     ...
     * Sets document_count
     *
     * @param int $document_count Number of documents bundled in the pdf
     *
     * @return $this
     */
    public function setDocumentCount(int $document_count): static
    {
     ...
     * Gets documents
     *
     * @return \Tyre24\Common\Model\ResponseDocumentData[]
     */
     ...
     * Sets documents
     *
     * @param \Tyre24\Common\Model\ResponseDocumentData[] $documents Details of the documents contained in the pdf
     *
     * @return $this
     */
