 ...
 */
class Assurance implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Assurance';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('latest_date', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['latest_date'] === null) {
            $invalidProperties[] = "'latest_date' can't be null";
        }
     ...
     * Sets status
     *
     * @param int $status Insurance status 0-2
     *
     * @return $this
     */
     ...
     * Sets latest_date
     *
     * @param string $latest_date The latest date where you can still make an insurance (time zone Europe/Berlin)
     *
     * @return $this
     */
    public function setLatestDate(string $latest_date): static
    {
        if (is_null($latest_date)) {
            throw new InvalidArgumentException('non-nullable latest_date cannot be null');
        }
     ...
     * Sets name
     *
     * @param string $name Name of the insurance
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param string $url Url for insurance pdf or insurance formular
     *
     * @return $this
     */
