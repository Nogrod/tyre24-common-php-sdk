...
/**
 * ResponseArticleType Class Doc Comment
 *
 * @package  Tyre24\Common
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ResponseArticleType implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ResponseArticleType';
    ...
    */
     ...
     * Sets key
     *
     * @param string $key api key of article
     *
     * @return $this
     */
     ...
     * Sets name_de
     *
     * @param string $name_de the German description of the article
     *
     * @return $this
     */
