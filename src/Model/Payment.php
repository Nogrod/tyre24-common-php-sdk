...
class Payment implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'method' => '\Tyre24\Common\Model\Method',
        'price_additional' => '\Tyre24\Common\Model\Price'
    ];
    ...
    protected static array $setters = [
        'method' => 'setMethod',
        'price_additional' => 'setPriceAdditional'
    ];
    ...
    protected static array $getters = [
        'method' => 'getMethod',
        'price_additional' => 'getPriceAdditional'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('price_additional', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['price_additional'] === null) {
            $invalidProperties[] = "'price_additional' can't be null";
        }
     ...
     * Gets method
     *
     * @return \Tyre24\Common\Model\Method
     */
    public function getMethod(): \Tyre24\Common\Model\Method
    {
     ...
     * Sets method
     *
     * @param \Tyre24\Common\Model\Method $method Contains information about the payment method
     *
     * @return $this
     */
    public function setMethod(\Tyre24\Common\Model\Method $method): static
    {
        if (is_null($method)) {
    ...
    /**
     * Gets price_additional
     *
     * @return \Tyre24\Common\Model\Price
     */
    public function getPriceAdditional(): \Tyre24\Common\Model\Price
    {
        return $this->container['price_additional'];
    }

    /**
     * Sets price_additional
     *
     * @param \Tyre24\Common\Model\Price $price_additional Additional fees for payment (e.g. paypal service fee)
     *
     * @return $this
     */
    public function setPriceAdditional(\Tyre24\Common\Model\Price $price_additional): static
    {
        if (is_null($price_additional)) {
            throw new InvalidArgumentException('non-nullable price_additional cannot be null');
        }
        $this->container['price_additional'] = $price_additional;
