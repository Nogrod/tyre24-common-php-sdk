...
/**
 * ResponseDocumentData Class Doc Comment
 *
 * @package  Tyre24\Common
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ResponseDocumentData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ResponseDocumentData';
    ...
    */
     ...
     * Sets creation_date
     *
     * @param string $creation_date Creation date (time zone Europe/Berlin)
     *
     * @return $this
     */
     ...
     *
     * @param string|null $reference_number A reference number for the given document
     *
     * @return $this
     */
     ...
     * Sets content
     *
     * @param string $content Base64 encoded content of document
     *
     * @return $this
     */
