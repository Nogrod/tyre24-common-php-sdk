...
class Attribute implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('generic_key', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['generic_key'] === null) {
            $invalidProperties[] = "'generic_key' can't be null";
        }
     ...
     * Sets key
     *
     * @param string $key The key contains the translation of the generic_key in the requested accept-language, as specified in the header.
     *
     * @return $this
     */
     ...
     * @return string
     */
    public function getGenericKey(): string
    {
        return $this->container['generic_key'];
    }

    /**
     * Sets generic_key
     *
     * @param string $generic_key This generic_key is a unique identifier of this attribute. It is independent of the requested accept-language.
     *
     * @return $this
     */
    public function setGenericKey(string $generic_key): static
    {
        if (is_null($generic_key)) {
            throw new InvalidArgumentException('non-nullable generic_key cannot be null');
        }
        $this->container['generic_key'] = $generic_key;
