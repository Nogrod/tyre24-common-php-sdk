...
/**
 * GetAvailableOrderStatusesListFilterParameterInner Class Doc Comment
 *
 * @package  Tyre24\Common
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetAvailableOrderStatusesListFilterParameterInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getAvailableOrderStatusesList_filter_parameter_inner';
    ...
    protected static array $openAPITypes = [
        ...
        'send_mail' => 'bool',
        'key' => 'string',
        'settable_by_buyer' => 'string',
        'settable_by_seller' => 'string'
    ];
    ...
    protected static array $openAPIFormats = [
        ...
        'send_mail' => null,
        'key' => null,
        'settable_by_buyer' => null,
        'settable_by_seller' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'send_mail' => false,
        'key' => false,
        'settable_by_buyer' => false,
        'settable_by_seller' => false
    ];
    ...
    protected static array $attributeMap = [
        ...
        'send_mail' => 'send_mail',
        'key' => 'key',
        'settable_by_buyer' => 'settableByBuyer',
        'settable_by_seller' => 'settableBySeller'
    ];
    ...
    protected static array $setters = [
        ...
        'key' => 'setKey',
        'settable_by_buyer' => 'setSettableByBuyer',
        'settable_by_seller' => 'setSettableBySeller'
    ];
    ...
    protected static array $getters = [
        ...
        'key' => 'getKey',
        'settable_by_buyer' => 'getSettableByBuyer',
        'settable_by_seller' => 'getSettableBySeller'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('settable_by_buyer', $data ?? [], null);
        $this->setIfExists('settable_by_seller', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Filter the result set by status id.  Allowed operators are:  | operator | example | | ------ | ------ | | `eq` | `eq;1337` |
     *
     * @return $this
     */
     ...
     * Sets send_mail
     *
     * @param bool|null $send_mail Filter the result set by send-email flag.  Allowed operators are:  | operator | example | | ------ | ------ | | `eq` | `eq;1` |
     *
     * @return $this
     */
    public function setSendMail(?bool $send_mail): static
    {
     ...
     * Sets key
     *
     * @param string|null $key Filter the result set by key.  Allowed operators are:  | operator | example | | ------ | ------ | | `eq` | `eq;john doe` |
     *
     * @return $this
     */
    ...
    /**
     * Gets settable_by_buyer
     *
     * @return string|null
     */
    public function getSettableByBuyer(): ?string
    {
        return $this->container['settable_by_buyer'];
    }

    /**
     * Sets settable_by_buyer
     *
     * @param string|null $settable_by_buyer All order statuses that can be set by the buyer  Allowed operators are:  | operator | example | | ------ | ------ | | `eq` | `eq;1337` |
     *
     * @return $this
     */
    public function setSettableByBuyer(?string $settable_by_buyer): static
    {
        if (is_null($settable_by_buyer)) {
            throw new InvalidArgumentException('non-nullable settable_by_buyer cannot be null');
        }
        $this->container['settable_by_buyer'] = $settable_by_buyer;

        return $this;
    }

    /**
     * Gets settable_by_seller
     *
     * @return string|null
     */
    public function getSettableBySeller(): ?string
    {
        return $this->container['settable_by_seller'];
    }

    /**
     * Sets settable_by_seller
     *
     * @param string|null $settable_by_seller All order statuses that can be set by the seller  Allowed operators are:  | operator | example | | ------ | ------ | | `eq` | `eq;1337` |
     *
     * @return $this
     */
    public function setSettableBySeller(?string $settable_by_seller): static
    {
        if (is_null($settable_by_seller)) {
            throw new InvalidArgumentException('non-nullable settable_by_seller cannot be null');
        }
        $this->container['settable_by_seller'] = $settable_by_seller;
