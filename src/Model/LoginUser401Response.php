...
class LoginUser401Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'loginUser_401_response';
    ...
    protected static array $openAPITypes = [
        'data' => '\Tyre24\Common\Model\ResponseAuthError'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Tyre24\Common\Model\ResponseAuthError|null
     */
    public function getData(): ?\Tyre24\Common\Model\ResponseAuthError
    {
     ...
     * Sets data
     *
     * @param \Tyre24\Common\Model\ResponseAuthError|null $data data
     *
     * @return $this
     */
    public function setData(?\Tyre24\Common\Model\ResponseAuthError $data): static
    {
        if (is_null($data)) {
