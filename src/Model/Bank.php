...
class Bank implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Bank';
    ...
    protected static array $setters = [
        ...
        'recently_changed' => 'setRecentlyChanged'
    ];
    ...
    protected static array $getters = [
        ...
        'recently_changed' => 'getRecentlyChanged'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('recently_changed', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['bic_swift'] === null) {
            $invalidProperties[] = "'bic_swift' can't be null";
        }
     ...
     * Sets owner
     *
     * @param string $owner Bank account owner
     *
     * @return $this
     */
     ...
     * Sets bic_swift
     *
     * @param string $bic_swift Bic/swift
     *
     * @return $this
     */
    public function setBicSwift(string $bic_swift): static
    {
     ...
     *
     * @param string|null $last_change_date If given, the date when the bank date has been changed for the last time
     *
     * @return $this
     */
    public function setLastChangeDate(?string $last_change_date): static
    {
    ...
    /**
     * Gets recently_changed
     *
     * @return bool|null
     */
    public function getRecentlyChanged(): ?bool
    {
        return $this->container['recently_changed'];
    }

    /**
     * Sets recently_changed
     *
     * @param bool|null $recently_changed True if the bank data has changed within the last 30 days, otherwise false
     *
     * @return $this
     */
    public function setRecentlyChanged(?bool $recently_changed): static
    {
        if (is_null($recently_changed)) {
            throw new InvalidArgumentException('non-nullable recently_changed cannot be null');
        }
        $this->container['recently_changed'] = $recently_changed;
