<?php
/**
 * GetAvailableArticleTypesList401Response
 *
 * PHP version 8.1
 *
...
/**
 * GetAvailableArticleTypesList401Response Class Doc Comment
 *
 * @package  Tyre24\Common
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetAvailableArticleTypesList401Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getAvailableArticleTypesList_401_response';
    ...
    protected static array $openAPITypes = [
        'data' => '\Tyre24\Common\Model\AccessControlErrorResponse'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Tyre24\Common\Model\AccessControlErrorResponse|null
     */
    public function getData(): ?\Tyre24\Common\Model\AccessControlErrorResponse
    {
     ...
     * Sets data
     *
     * @param \Tyre24\Common\Model\AccessControlErrorResponse|null $data data
     *
     * @return $this
     */
    public function setData(?\Tyre24\Common\Model\AccessControlErrorResponse $data): static
    {
        if (is_null($data)) {
