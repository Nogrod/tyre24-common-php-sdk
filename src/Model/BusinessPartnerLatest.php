...
/**
 * BusinessPartnerLatest Class Doc Comment
 *
 * @package  Tyre24\Common
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class BusinessPartnerLatest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'businessPartnerLatest';
    ...
    protected static array $openAPITypes = [
        'contact' => '\Tyre24\Common\Model\ContactLatest',
        'buyer_invoice_route_id' => 'string',
        'id' => 'int',
        'status_name' => 'string',
        'recipient_code' => 'string',
        'address' => '\Tyre24\Common\Model\Address',
        'tax' => '\Tyre24\Common\Model\Tax',
        'bank' => '\Tyre24\Common\Model\Bank',
        'credit_reform' => '\Tyre24\Common\Model\CreditReform',
        'cooperation' => '\Tyre24\Common\Model\Organisation',
        'rating' => 'int'
    ];
    ...
    protected static array $attributeMap = [
        'contact' => 'contact',
        'buyer_invoice_route_id' => 'buyer_invoice_route_id',
        'id' => 'id',
    ...
    protected static array $setters = [
        'contact' => 'setContact',
        'buyer_invoice_route_id' => 'setBuyerInvoiceRouteId',
        'id' => 'setId',
    ...
    protected static array $getters = [
        'contact' => 'getContact',
        'buyer_invoice_route_id' => 'getBuyerInvoiceRouteId',
        'id' => 'getId',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('buyer_invoice_route_id', $data ?? [], null);
        ...
        $this->setIfExists('credit_reform', $data ?? [], null);
        $this->setIfExists('cooperation', $data ?? [], null);
    ...
    */
     ...
     * Gets contact
     *
     * @return \Tyre24\Common\Model\ContactLatest|null
     */
    public function getContact(): ?\Tyre24\Common\Model\ContactLatest
    {
     ...
     * Sets contact
     *
     * @param \Tyre24\Common\Model\ContactLatest|null $contact Contact information
     *
     * @return $this
     */
    public function setContact(?\Tyre24\Common\Model\ContactLatest $contact): static
    {
        if (is_null($contact)) {
    ...
    /**
     * Gets buyer_invoice_route_id
     *
     * @return string|null
     */
    public function getBuyerInvoiceRouteId(): ?string
    {
        return $this->container['buyer_invoice_route_id'];
    }

    /**
     * Sets buyer_invoice_route_id
     *
     * @param string|null $buyer_invoice_route_id e-invoice buyer route ID
     *
     * @return $this
     */
    public function setBuyerInvoiceRouteId(?string $buyer_invoice_route_id): static
    {
        if (is_null($buyer_invoice_route_id)) {
            throw new InvalidArgumentException('non-nullable buyer_invoice_route_id cannot be null');
        }
        $this->container['buyer_invoice_route_id'] = $buyer_invoice_route_id;
     ...
     * Sets id
     *
     * @param int $id Tyre24 id of the customer
     *
     * @return $this
     */
     ...
     * Sets status_name
     *
     * @param string|null $status_name Status name of the customer
     *
     * @return $this
     */
     ...
     * Sets recipient_code
     *
     * @param string $recipient_code Recipient code (required in italy)
     *
     * @return $this
     */
    public function setRecipientCode(string $recipient_code): static
    {
     ...
     * Gets address
     *
     * @return \Tyre24\Common\Model\Address|null
     */
    public function getAddress(): ?\Tyre24\Common\Model\Address
    {
     ...
     * Sets address
     *
     * @param \Tyre24\Common\Model\Address|null $address Address
     *
     * @return $this
     */
    public function setAddress(?\Tyre24\Common\Model\Address $address): static
    {
        if (is_null($address)) {
     ...
     * Gets tax
     *
     * @return \Tyre24\Common\Model\Tax|null
     */
    public function getTax(): ?\Tyre24\Common\Model\Tax
    {
     ...
     * Sets tax
     *
     * @param \Tyre24\Common\Model\Tax|null $tax Tax information
     *
     * @return $this
     */
    public function setTax(?\Tyre24\Common\Model\Tax $tax): static
    {
        if (is_null($tax)) {
     ...
     * Gets bank
     *
     * @return \Tyre24\Common\Model\Bank|null
     */
    public function getBank(): ?\Tyre24\Common\Model\Bank
    {
     ...
     * Sets bank
     *
     * @param \Tyre24\Common\Model\Bank|null $bank Bank account information
     *
     * @return $this
     */
    public function setBank(?\Tyre24\Common\Model\Bank $bank): static
    {
        if (is_null($bank)) {
     ...
     * Gets credit_reform
     *
     * @return \Tyre24\Common\Model\CreditReform|null
     */
    public function getCreditReform(): ?\Tyre24\Common\Model\CreditReform
    {
        return $this->container['credit_reform'];
    }

    /**
     * Sets credit_reform
     *
     * @param \Tyre24\Common\Model\CreditReform|null $credit_reform Credit reform information
     *
     * @return $this
     */
    public function setCreditReform(?\Tyre24\Common\Model\CreditReform $credit_reform): static
    {
        if (is_null($credit_reform)) {
            throw new InvalidArgumentException('non-nullable credit_reform cannot be null');
        }
        $this->container['credit_reform'] = $credit_reform;
     ...
     * Gets cooperation
     *
     * @return \Tyre24\Common\Model\Organisation|null
     */
    public function getCooperation(): ?\Tyre24\Common\Model\Organisation
    {
     ...
     * Sets cooperation
     *
     * @param \Tyre24\Common\Model\Organisation|null $cooperation Information about cooperation
     *
     * @return $this
     */
    public function setCooperation(?\Tyre24\Common\Model\Organisation $cooperation): static
    {
        if (is_null($cooperation)) {
            throw new InvalidArgumentException('non-nullable cooperation cannot be null');
        }
     ...
     * Sets rating
     *
     * @param int|null $rating The rating of the supplier, where 1 is good and 0 is bad. If this point is not given the rating is neutral.
     *
     * @return $this
     */
