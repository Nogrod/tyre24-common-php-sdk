...
class ResponseDetails implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $attributeMap = [
        ...
        'alzura_pay_invoice_id' => 'alzura_pay_invoice_id',
        'is_payed' => 'is_payed',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('order_contact', $data ?? [], null);
        ...
        $this->setIfExists('alzura_pay_invoice_id', $data ?? [], null);
    ...
    */
     ...
     * Gets order_contact
     *
     * @return \Tyre24\Common\Model\OrderContact|null
     */
    public function getOrderContact(): ?\Tyre24\Common\Model\OrderContact
    {
        return $this->container['order_contact'];
    }

    /**
     * Sets order_contact
     *
     * @param \Tyre24\Common\Model\OrderContact|null $order_contact The contact person who placed the order.
     *
     * @return $this
     */
    public function setOrderContact(?\Tyre24\Common\Model\OrderContact $order_contact): static
    {
        if (is_null($order_contact)) {
            throw new InvalidArgumentException('non-nullable order_contact cannot be null');
        }
        $this->container['order_contact'] = $order_contact;
    ...
    /**
     * Gets alzura_pay_invoice_id
     *
     * @return string|null
     */
    public function getAlzuraPayInvoiceId(): ?string
    {
        return $this->container['alzura_pay_invoice_id'];
    }

    /**
     * Sets alzura_pay_invoice_id
     *
     * @param string|null $alzura_pay_invoice_id The ALZURA PAY invoice id, if given.
     *
     * @return $this
     */
    public function setAlzuraPayInvoiceId(?string $alzura_pay_invoice_id): static
    {
        if (is_null($alzura_pay_invoice_id)) {
            throw new InvalidArgumentException('non-nullable alzura_pay_invoice_id cannot be null');
        }
        $this->container['alzura_pay_invoice_id'] = $alzura_pay_invoice_id;
