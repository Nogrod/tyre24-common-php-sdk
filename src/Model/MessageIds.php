 ...
 */
class MessageIds implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'MessageIds';
    ...
    */
     ...
     * Sets message_ids
     *
     * @param int[] $message_ids The message ids
     *
     * @return $this
     */
