 ...
 */
class ResponseStatus implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ResponseStatus';
    ...
    protected static array $getters = [
        ...
        'key' => 'getKey',
        'name' => 'getName',
        'comment_required' => 'getCommentRequired'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('comment_required', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['send_mail'] === null) {
            $invalidProperties[] = "'send_mail' can't be null";
        }
        ...
        if ($this->container['comment_required'] === null) {
            $invalidProperties[] = "'comment_required' can't be null";
        }
     ...
     * Sets send_mail
     *
     * @param bool $send_mail Notify flag: Business partner will get email when status changes
     *
     * @return $this
     */
     ...
     * Sets key
     *
     * @param string $key Generic order status key
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Order status name
     *
     * @return $this
     */
    ...
    /**
     * Gets comment_required
     *
     * @return bool
     */
    public function getCommentRequired(): bool
    {
        return $this->container['comment_required'];
    }

    /**
     * Sets comment_required
     *
     * @param bool $comment_required Defines whether the status requires a comment on change
     *
     * @return $this
     */
    public function setCommentRequired(bool $comment_required): static
    {
        if (is_null($comment_required)) {
            throw new InvalidArgumentException('non-nullable comment_required cannot be null');
        }
        $this->container['comment_required'] = $comment_required;
