...
class Organisation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Organisation';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('show_name', $data ?? [], null);
        $this->setIfExists('show_number', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['show_number'] === null) {
            $invalidProperties[] = "'show_number' can't be null";
        }
     ...
     * Sets number
     *
     * @param string $number Number of the cooperation
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Name of the cooperation
     *
     * @return $this
     */
     ...
     * Sets show_name
     *
     * @param bool $show_name Indicates whether the actual Cooperation name is visible,             based on the visibility settings for the Cooperation.
     *
     * @return $this
     */
    public function setShowName(bool $show_name): static
    {
        if (is_null($show_name)) {
            throw new InvalidArgumentException('non-nullable show_name cannot be null');
        }
     ...
     * @return bool
     */
    public function getShowNumber(): bool
    {
        return $this->container['show_number'];
    }

    /**
     * Sets show_number
     *
     * @param bool $show_number Indicates whether the actual Cooperation number is visible,             based on the visibility settings for the Cooperation.
     *
     * @return $this
     */
    public function setShowNumber(bool $show_number): static
    {
        if (is_null($show_number)) {
            throw new InvalidArgumentException('non-nullable show_number cannot be null');
        }
        $this->container['show_number'] = $show_number;
