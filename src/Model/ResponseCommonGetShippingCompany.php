...
/**
 * ResponseCommonGetShippingCompany Class Doc Comment
 *
 * @package  Tyre24\Common
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ResponseCommonGetShippingCompany implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ResponseCommonGetShippingCompany';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id Internal id of the shipping company. This id will be used in other endpoints.
     *
     * @return $this
     */
     ...
     * Sets country
     *
     * @param string $country Country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code, e.g. de)
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name The name of the shipping company
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param string|null $url URL of the shipping company to track a package. The placeholer ##PACELNUMBER## can be replaced with a given package number for the given shipping company.
     *
     * @return $this
     */
