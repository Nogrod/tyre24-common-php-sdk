...
class AuthenticationApi
{
     ...
     * @return \Tyre24\Common\Model\LoginUser200Response|\Tyre24\Common\Model\LoginUser401Response
     */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Tyre24\Common\Model\LoginUser200Response|\Tyre24\Common\Model\LoginUser401Response, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch ($statusCode) {
                case 200:
                    if (in_array('\Tyre24\Common\Model\LoginUser200Response', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'], true)) {
                        ...
                        if ('\Tyre24\Common\Model\LoginUser200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Tyre24\Common\Model\LoginUser200Response', []),
                ...
                case 401:
                    if (in_array('\Tyre24\Common\Model\LoginUser401Response', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'], true)) {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Tyre24\Common\Model\LoginUser401Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Tyre24\Common\Model\LoginUser401Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tyre24\Common\Model\LoginUser200Response',
                ...
                case 401:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tyre24\Common\Model\LoginUser401Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
