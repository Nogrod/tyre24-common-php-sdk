...
class DocumentsApi
{
    ...
    /**
     * Operation getDocumentsByTypeAndId
     *
     ...
     * @param  string $order Filter documents by order id. (required)
     * @param  string $type Filter documents by type. (required)
     * @param  \Tyre24\Common\Model\GetDocumentsByTypeAndIdFilterParameterInner[]|null $filter filter (optional)
     * @param  int|null $limit Limit your search to list only a specific amount of records.  If you leave the field blank, all records will be returned. (optional)
     * @param  int|null $offset Paginate the result of your search.  _If **limit** is not being passed, the value passed to offset will be ignored._ (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDocumentsByTypeAndId'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \Tyre24\Common\Model\GetDocumentsByTypeAndId200Response|\Tyre24\Common\Model\GetAvailableArticleTypesList400Response|\Tyre24\Common\Model\GetAvailableArticleTypesList401Response
     */
    public function getDocumentsByTypeAndId(
        string $country,
        string $order,
        string $type,
        ?array $filter = null,
    ...
    ): \Tyre24\Common\Model\GetDocumentsByTypeAndId200Response
    {
    ...
    /**
     * Operation getDocumentsByTypeAndIdWithHttpInfo
     *
     * Get base64 encoded documents.
     *
     * @param  string $country country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code). (required)
     * @param  string $order Filter documents by order id. (required)
     * @param  string $type Filter documents by type. (required)
     * @param  \Tyre24\Common\Model\GetDocumentsByTypeAndIdFilterParameterInner[]|null $filter (optional)
     * @param  int|null $limit Limit your search to list only a specific amount of records.  If you leave the field blank, all records will be returned. (optional)
     * @param  int|null $offset Paginate the result of your search.  _If **limit** is not being passed, the value passed to offset will be ignored._ (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDocumentsByTypeAndId'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Tyre24\Common\Model\GetDocumentsByTypeAndId200Response|\Tyre24\Common\Model\GetAvailableArticleTypesList400Response|\Tyre24\Common\Model\GetAvailableArticleTypesList401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDocumentsByTypeAndIdWithHttpInfo(
        string $country,
        string $order,
        string $type,
        ?array $filter = null,
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\Tyre24\Common\Model\GetDocumentsByTypeAndId200Response', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        ...
                        if ('\Tyre24\Common\Model\GetDocumentsByTypeAndId200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Tyre24\Common\Model\GetDocumentsByTypeAndId200Response', []),
    ...
    /**
     * Operation getDocumentsByTypeAndIdAsync
     *
     * Get base64 encoded documents.
     *
     * @param  string $country country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code). (required)
     ...
     */
    public function getDocumentsByTypeAndIdAsync(
        string $country,
        string $order,
        string $type,
        ?array $filter = null,
    ...
    /**
     * Operation getDocumentsByTypeAndIdAsyncWithHttpInfo
     *
     * Get base64 encoded documents.
     *
     * @param  string $country country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code). (required)
     ...
     * @return PromiseInterface
     */
    public function getDocumentsByTypeAndIdAsyncWithHttpInfo(
        $country,
        $order,
        $type,
        $filter = null,
    ...
    /**
     * Create request for operation 'getDocumentsByTypeAndId'
     *
     * @param  string $country country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code). (required)
     * @param  string $order Filter documents by order id. (required)
     * @param  string $type Filter documents by type. (required)
     ...
     */
    public function getDocumentsByTypeAndIdRequest(
        $country,
        $order,
        $type,
        $filter = null,
    ...
    ): Request
    {
        ...
        if ($country === null || (is_array($country) && count($country) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $country when calling getDocumentsByTypeAndId'
            );
        }
        ...
        if ($order === null || (is_array($order) && count($order) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $order when calling getDocumentsByTypeAndId'
            );
        }
        ...
        if ($type === null || (is_array($type) && count($type) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $type when calling getDocumentsByTypeAndId'
            );
        }
