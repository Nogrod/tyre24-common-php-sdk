...
class MessagesApi
{
    ...
    /**
     * Operation markMessagesReadByMessageIds
     *
     * Mark messages as read
     *
     * @param  string|null $content_type The content type for all json requests. If not specified, errors related to missing required request body parameters will be returned. (optional)
     * @param  \Tyre24\Common\Model\MessageIds|null $message_ids message_ids (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['markMessagesReadByMessageIds'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \Tyre24\Common\Model\GetAvailableArticleTypesList400Response|\Tyre24\Common\Model\GetAvailableArticleTypesList401Response|null
     */
    public function markMessagesReadByMessageIds(
        ?string $content_type = null,
        ?\Tyre24\Common\Model\MessageIds $message_ids = null,
        string $contentType = self::contentTypes['markMessagesReadByMessageIds'][0]
    ): \Tyre24\Common\Model\GetAvailableArticleTypesList400Response|\Tyre24\Common\Model\GetAvailableArticleTypesList401Response|null {
        list($response) = $this->markMessagesReadByMessageIdsWithHttpInfo($content_type, $message_ids, $contentType);
        return $response;
    }

    /**
     * Operation markMessagesReadByMessageIdsWithHttpInfo
     *
     * Mark messages as read
     *
     * @param  string|null $content_type The content type for all json requests. If not specified, errors related to missing required request body parameters will be returned. (optional)
     * @param  \Tyre24\Common\Model\MessageIds|null $message_ids (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['markMessagesReadByMessageIds'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     ...
     */
    public function markMessagesReadByMessageIdsWithHttpInfo(
        ?string $content_type = null,
        ?\Tyre24\Common\Model\MessageIds $message_ids = null,
        string $contentType = self::contentTypes['markMessagesReadByMessageIds'][0]
    ): array {
    ...
    /**
     * Operation markMessagesReadByMessageIdsAsync
     *
     * Mark messages as read
     *
     * @param  string|null $content_type The content type for all json requests. If not specified, errors related to missing required request body parameters will be returned. (optional)
     ...
     */
    public function markMessagesReadByMessageIdsAsync(
        ?string $content_type = null,
        ?\Tyre24\Common\Model\MessageIds $message_ids = null,
        string $contentType = self::contentTypes['markMessagesReadByMessageIds'][0]
    ): PromiseInterface {
    ...
    /**
     * Operation markMessagesReadByMessageIdsAsyncWithHttpInfo
     *
     * Mark messages as read
     *
     * @param  string|null $content_type The content type for all json requests. If not specified, errors related to missing required request body parameters will be returned. (optional)
     ...
     * @return PromiseInterface
     */
    public function markMessagesReadByMessageIdsAsyncWithHttpInfo(
        ?string $content_type = null,
        ?\Tyre24\Common\Model\MessageIds $message_ids = null,
        string $contentType = self::contentTypes['markMessagesReadByMessageIds'][0]
    ): PromiseInterface {
    ...
    /**
     * Create request for operation 'markMessagesReadByMessageIds'
     *
     * @param  string|null $content_type The content type for all json requests. If not specified, errors related to missing required request body parameters will be returned. (optional)
     * @param  \Tyre24\Common\Model\MessageIds|null $message_ids (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['markMessagesReadByMessageIds'] to see the possible values for this operation
     ...
     */
    public function markMessagesReadByMessageIdsRequest(
        ?string $content_type = null,
        ?\Tyre24\Common\Model\MessageIds $message_ids = null,
        string $contentType = self::contentTypes['markMessagesReadByMessageIds'][0]
    ): Request {
        ...
        $resourcePath = '/common/message/read';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (isset($message_ids)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($message_ids));
            } else {
                $httpBody = $message_ids;
            }
