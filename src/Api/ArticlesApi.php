...
class ArticlesApi
{
    ...
    /**
     * Operation getAvailableArticleTypesList
     *
     ...
     * @param  \Tyre24\Common\Model\GetAvailableArticleTypesListFilterParameterInner[]|null $filter filter (optional)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAvailableArticleTypesList'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \Tyre24\Common\Model\GetAvailableArticleTypesList200Response|\Tyre24\Common\Model\GetAvailableArticleTypesList400Response|\Tyre24\Common\Model\GetAvailableArticleTypesList401Response
     */
    public function getAvailableArticleTypesList(
        string $country,
        ?array $filter = null,
        ?string $accept_language = null,
        string $contentType = self::contentTypes['getAvailableArticleTypesList'][0]
    ): \Tyre24\Common\Model\GetAvailableArticleTypesList200Response|\Tyre24\Common\Model\GetAvailableArticleTypesList400Response|\Tyre24\Common\Model\GetAvailableArticleTypesList401Response {
        list($response) = $this->getAvailableArticleTypesListWithHttpInfo($country, $filter, $accept_language, $contentType);
        return $response;
    }

    /**
     * Operation getAvailableArticleTypesListWithHttpInfo
     *
     * Get the article types list.
     *
     * @param  string $country country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code). (required)
     * @param  \Tyre24\Common\Model\GetAvailableArticleTypesListFilterParameterInner[]|null $filter (optional)
     * @param  string|null $accept_language ISO 639-1 standard language codes. As default, even for invalid values, de_DE will be used! (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAvailableArticleTypesList'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Tyre24\Common\Model\GetAvailableArticleTypesList200Response|\Tyre24\Common\Model\GetAvailableArticleTypesList400Response|\Tyre24\Common\Model\GetAvailableArticleTypesList401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAvailableArticleTypesListWithHttpInfo(
        string $country,
        ?array $filter = null,
        ?string $accept_language = null,
        string $contentType = self::contentTypes['getAvailableArticleTypesList'][0]
    ): array {
        $request = $this->getAvailableArticleTypesListRequest($country, $filter, $accept_language, $contentType);
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if (in_array('\Tyre24\Common\Model\GetAvailableArticleTypesList200Response', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'], true)) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Tyre24\Common\Model\GetAvailableArticleTypesList200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Tyre24\Common\Model\GetAvailableArticleTypesList200Response', []),
            ...
            $returnType = '\Tyre24\Common\Model\GetAvailableArticleTypesList200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tyre24\Common\Model\GetAvailableArticleTypesList200Response',
    ...
    /**
     * Operation getAvailableArticleTypesListAsync
     *
     * Get the article types list.
     *
     * @param  string $country country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code). (required)
     ...
     */
    public function getAvailableArticleTypesListAsync(
        string $country,
        ?array $filter = null,
        ?string $accept_language = null,
        string $contentType = self::contentTypes['getAvailableArticleTypesList'][0]
    ): PromiseInterface {
        return $this->getAvailableArticleTypesListAsyncWithHttpInfo($country, $filter, $accept_language, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAvailableArticleTypesListAsyncWithHttpInfo
     *
     * Get the article types list.
     *
     * @param  string $country country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code). (required)
     ...
     * @return PromiseInterface
     */
    public function getAvailableArticleTypesListAsyncWithHttpInfo(
        string $country,
        ?array $filter = null,
        ?string $accept_language = null,
        string $contentType = self::contentTypes['getAvailableArticleTypesList'][0]
    ...
    /**
     * Create request for operation 'getAvailableArticleTypesList'
     *
     * @param  string $country country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code). (required)
     * @param  \Tyre24\Common\Model\GetAvailableArticleTypesListFilterParameterInner[]|null $filter (optional)
     * @param  string|null $accept_language ISO 639-1 standard language codes. As default, even for invalid values, de_DE will be used! (optional)
     ...
     */
    public function getAvailableArticleTypesListRequest(
        string $country,
        ?array $filter = null,
        ?string $accept_language = null,
        string $contentType = self::contentTypes['getAvailableArticleTypesList'][0]
        ...
        if ($country === null || (is_array($country) && count($country) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $country when calling getAvailableArticleTypesList'
            );
        }
        ...
        $resourcePath = '/common/article-types';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
