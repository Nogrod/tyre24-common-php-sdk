...
class ShippingApi
{
    ...
    /**
     * Operation getShippingCompaniesByCountry
     *
     ...
     * @param  \Tyre24\Common\Model\GetShippingCompaniesByCountryFilterParameterInner[]|null $filter filter (optional)
     * @param  string|null $sort Sort the result of your search.  _If the key to sort starts with a **-**, then the result is sorted in descending order._ _If the sort key starts with a **+** or only the key is specified, the result is sorted in ascending order._  Available sorters:  | name | description | example | | ------ | ----------- | ------- | | id | Sort the result by id | -id | | name | Sort the result by name | -name | (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getShippingCompaniesByCountry'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \Tyre24\Common\Model\GetShippingCompaniesByCountry200Response|\Tyre24\Common\Model\GetAvailableArticleTypesList400Response|\Tyre24\Common\Model\GetAvailableArticleTypesList401Response
     */
    public function getShippingCompaniesByCountry(
        string $country,
        ?array $filter = null,
        ?string $sort = null,
        string $contentType = self::contentTypes['getShippingCompaniesByCountry'][0]
    ): \Tyre24\Common\Model\GetShippingCompaniesByCountry200Response|\Tyre24\Common\Model\GetAvailableArticleTypesList400Response|\Tyre24\Common\Model\GetAvailableArticleTypesList401Response {
        list($response) = $this->getShippingCompaniesByCountryWithHttpInfo($country, $filter, $sort, $contentType);
        return $response;
    }

    /**
     * Operation getShippingCompaniesByCountryWithHttpInfo
     *
     * Get a list of shipping companies in a given country.
     *
     * @param  string $country country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code). (required)
     * @param  \Tyre24\Common\Model\GetShippingCompaniesByCountryFilterParameterInner[]|null $filter (optional)
     * @param  string|null $sort Sort the result of your search.  _If the key to sort starts with a **-**, then the result is sorted in descending order._ _If the sort key starts with a **+** or only the key is specified, the result is sorted in ascending order._  Available sorters:  | name | description | example | | ------ | ----------- | ------- | | id | Sort the result by id | -id | | name | Sort the result by name | -name | (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getShippingCompaniesByCountry'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Tyre24\Common\Model\GetShippingCompaniesByCountry200Response|\Tyre24\Common\Model\GetAvailableArticleTypesList400Response|\Tyre24\Common\Model\GetAvailableArticleTypesList401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getShippingCompaniesByCountryWithHttpInfo(
        string $country,
        ?array $filter = null,
        ?string $sort = null,
        string $contentType = self::contentTypes['getShippingCompaniesByCountry'][0]
    ): array {
        $request = $this->getShippingCompaniesByCountryRequest($country, $filter, $sort, $contentType);
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if (in_array('\Tyre24\Common\Model\GetShippingCompaniesByCountry200Response', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'], true)) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Tyre24\Common\Model\GetShippingCompaniesByCountry200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Tyre24\Common\Model\GetShippingCompaniesByCountry200Response', []),
            ...
            $returnType = '\Tyre24\Common\Model\GetShippingCompaniesByCountry200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tyre24\Common\Model\GetShippingCompaniesByCountry200Response',
    ...
    /**
     * Operation getShippingCompaniesByCountryAsync
     *
     * Get a list of shipping companies in a given country.
     *
     * @param  string $country country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code). (required)
     ...
     */
    public function getShippingCompaniesByCountryAsync(
        string $country,
        ?array $filter = null,
        ?string $sort = null,
        string $contentType = self::contentTypes['getShippingCompaniesByCountry'][0]
    ): PromiseInterface {
        return $this->getShippingCompaniesByCountryAsyncWithHttpInfo($country, $filter, $sort, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getShippingCompaniesByCountryAsyncWithHttpInfo
     *
     * Get a list of shipping companies in a given country.
     *
     * @param  string $country country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code). (required)
     ...
     * @return PromiseInterface
     */
    public function getShippingCompaniesByCountryAsyncWithHttpInfo(
        string $country,
        ?array $filter = null,
        ?string $sort = null,
        string $contentType = self::contentTypes['getShippingCompaniesByCountry'][0]
    ...
    /**
     * Create request for operation 'getShippingCompaniesByCountry'
     *
     * @param  string $country country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code). (required)
     * @param  \Tyre24\Common\Model\GetShippingCompaniesByCountryFilterParameterInner[]|null $filter (optional)
     * @param  string|null $sort Sort the result of your search.  _If the key to sort starts with a **-**, then the result is sorted in descending order._ _If the sort key starts with a **+** or only the key is specified, the result is sorted in ascending order._  Available sorters:  | name | description | example | | ------ | ----------- | ------- | | id | Sort the result by id | -id | | name | Sort the result by name | -name | (optional)
     ...
     */
    public function getShippingCompaniesByCountryRequest(
        string $country,
        ?array $filter = null,
        ?string $sort = null,
        string $contentType = self::contentTypes['getShippingCompaniesByCountry'][0]
        ...
        if ($country === null || (is_array($country) && count($country) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $country when calling getShippingCompaniesByCountry'
            );
        }
        ...
        $resourcePath = '/common/shipping-companies';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
