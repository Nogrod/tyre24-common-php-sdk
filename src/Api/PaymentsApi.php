...
class PaymentsApi
{
    ...
    /**
     * Operation getPaymentMethodsForAuthenticatedUser
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getPaymentMethodsForAuthenticatedUser'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \Tyre24\Common\Model\GetPaymentMethodsForAuthenticatedUser200Response|\Tyre24\Common\Model\GetAvailableArticleTypesList400Response|\Tyre24\Common\Model\GetAvailableArticleTypesList401Response
     */
    ...
    ): \Tyre24\Common\Model\GetPaymentMethodsForAuthenticatedUser200Response
    {
    ...
    /**
     * Operation getPaymentMethodsForAuthenticatedUserWithHttpInfo
     *
     * Get all available payment methods for the authenticated user in the given country.
     *
     * @param  string $country country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code). (required)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Tyre24\Common\Model\GetPaymentMethodsForAuthenticatedUser200Response|\Tyre24\Common\Model\GetAvailableArticleTypesList400Response|\Tyre24\Common\Model\GetAvailableArticleTypesList401Response, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\Tyre24\Common\Model\GetPaymentMethodsForAuthenticatedUser200Response', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        ...
                        if ('\Tyre24\Common\Model\GetPaymentMethodsForAuthenticatedUser200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Tyre24\Common\Model\GetPaymentMethodsForAuthenticatedUser200Response', []),
    ...
    /**
     * Operation getPaymentMethodsForAuthenticatedUserAsync
     *
     * Get all available payment methods for the authenticated user in the given country.
     *
     * @param  string $country country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code). (required)
    ...
    /**
     * Operation getPaymentMethodsForAuthenticatedUserAsyncWithHttpInfo
     *
     * Get all available payment methods for the authenticated user in the given country.
     *
     * @param  string $country country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code). (required)
    ...
    /**
     * Create request for operation 'getPaymentMethodsForAuthenticatedUser'
     *
     * @param  string $country country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code). (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getPaymentMethodsForAuthenticatedUser'] to see the possible values for this operation
     *
    ...
    ): Request
    {
        ...
        if ($country === null || (is_array($country) && count($country) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $country when calling getPaymentMethodsForAuthenticatedUser'
            );
        }


        $resourcePath = '/common/payment-methods';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
