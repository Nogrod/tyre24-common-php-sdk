...
class OrdersApi
{
    ...
    /**
     * Operation getAvailableOrderStatusesList
     *
     * Get a list of order statuses.
     *
     * @param  \Tyre24\Common\Model\GetAvailableOrderStatusesListFilterParameterInner[]|null $filter filter (optional)
     * @param  string|null $accept_language ISO 639-1 standard language codes. As default, even for invalid values, de_DE will be used! (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAvailableOrderStatusesList'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \Tyre24\Common\Model\GetAvailableOrderStatusesList200Response|\Tyre24\Common\Model\GetAvailableArticleTypesList401Response
     */
    public function getAvailableOrderStatusesList(
        ?array $filter = null,
        ?string $accept_language = null,
        string $contentType = self::contentTypes['getAvailableOrderStatusesList'][0]
    ): \Tyre24\Common\Model\GetAvailableOrderStatusesList200Response
    {
    ...
    /**
     * Operation getAvailableOrderStatusesListWithHttpInfo
     *
     * Get a list of order statuses.
     *
     * @param  \Tyre24\Common\Model\GetAvailableOrderStatusesListFilterParameterInner[]|null $filter (optional)
     * @param  string|null $accept_language ISO 639-1 standard language codes. As default, even for invalid values, de_DE will be used! (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAvailableOrderStatusesList'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Tyre24\Common\Model\GetAvailableOrderStatusesList200Response|\Tyre24\Common\Model\GetAvailableArticleTypesList401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAvailableOrderStatusesListWithHttpInfo(
        ?array $filter = null,
        ?string $accept_language = null,
        string $contentType = self::contentTypes['getAvailableOrderStatusesList'][0]
    ): array
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\Tyre24\Common\Model\GetAvailableOrderStatusesList200Response', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        ...
                        if ('\Tyre24\Common\Model\GetAvailableOrderStatusesList200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Tyre24\Common\Model\GetAvailableOrderStatusesList200Response', []),
                ...
                case 401:
                    if (in_array('\Tyre24\Common\Model\GetAvailableArticleTypesList401Response', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Tyre24\Common\Model\GetAvailableArticleTypesList401Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Tyre24\Common\Model\GetAvailableArticleTypesList401Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                ...
                case 401:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tyre24\Common\Model\GetAvailableArticleTypesList401Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getAvailableOrderStatusesListAsync
     *
     * Get a list of order statuses.
     *
     * @param  \Tyre24\Common\Model\GetAvailableOrderStatusesListFilterParameterInner[]|null $filter (optional)
     ...
     */
    public function getAvailableOrderStatusesListAsync(
        ?array $filter = null,
        ?string $accept_language = null,
        string $contentType = self::contentTypes['getAvailableOrderStatusesList'][0]
    ): PromiseInterface
    ...
    /**
     * Operation getAvailableOrderStatusesListAsyncWithHttpInfo
     *
     * Get a list of order statuses.
     *
     * @param  \Tyre24\Common\Model\GetAvailableOrderStatusesListFilterParameterInner[]|null $filter (optional)
     ...
     * @return PromiseInterface
     */
    public function getAvailableOrderStatusesListAsyncWithHttpInfo(
        $filter = null,
    ...
    /**
     * Create request for operation 'getAvailableOrderStatusesList'
     *
     * @param  \Tyre24\Common\Model\GetAvailableOrderStatusesListFilterParameterInner[]|null $filter (optional)
     * @param  string|null $accept_language ISO 639-1 standard language codes. As default, even for invalid values, de_DE will be used! (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAvailableOrderStatusesList'] to see the possible values for this operation
     ...
     */
    public function getAvailableOrderStatusesListRequest(
        $filter = null,
        $accept_language = null,
        string $contentType = self::contentTypes['getAvailableOrderStatusesList'][0]
    ): Request
    {
        ...
        $resourcePath = '/common/order-status';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  int|null $counter Default 0. Data records are combined by the interface into blocks that can be retrieved again. (optional)
     * @param  bool|null $no_tagging 0: the returned orders are set with the next available counter, if not previously retrieved, and marked with access time (the access time will not be changed by subsequent calls with no_tagging&#x3D;0); 1: the returned orders are set with the next available counter, if not previously retrieved, but no access time will be set. (optional)
     * @param  string|null $tracking_number Valid values are: 0 &#x3D; all orders, 1 &#x3D; only orders with tracking, 2 &#x3D; only orders without tracking (optional)
     * @param  string|null $order_role Valid values are: SELLER, BUYER, SELLER_OR_BUYER, SELLER_AND_BUYER (optional)
     * @param  bool|null $demo 0: Real data is returned (default), 1: Demo data is returned. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getLatestOrders'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \Tyre24\Common\Model\GetLatestOrders200Response|\Tyre24\Common\Model\GetAvailableArticleTypesList400Response|\Tyre24\Common\Model\GetAvailableArticleTypesList400Response|\Tyre24\Common\Model\GetAvailableArticleTypesList401Response
     */
    public function getLatestOrders(
        string $country,
        ?int $counter = null,
        ?bool $no_tagging = null,
        ?string $tracking_number = null,
        ?string $order_role = null,
        ?bool $demo = null,
        string $contentType = self::contentTypes['getLatestOrders'][0]
    ): \Tyre24\Common\Model\GetLatestOrders200Response
    {
    ...
    /**
     * Operation getLatestOrdersWithHttpInfo
     *
     * Retrieve the latest orders.
     *
     * @param  string $country country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code). (required)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Tyre24\Common\Model\GetLatestOrders200Response|\Tyre24\Common\Model\GetAvailableArticleTypesList400Response|\Tyre24\Common\Model\GetAvailableArticleTypesList400Response|\Tyre24\Common\Model\GetAvailableArticleTypesList401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getLatestOrdersWithHttpInfo(
        string $country,
        ?int $counter = null,
        ?bool $no_tagging = null,
        ?string $tracking_number = null,
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\Tyre24\Common\Model\GetLatestOrders200Response', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Tyre24\Common\Model\GetLatestOrders200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Tyre24\Common\Model\GetLatestOrders200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if (in_array('\Tyre24\Common\Model\GetAvailableArticleTypesList400Response', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Tyre24\Common\Model\GetAvailableArticleTypesList400Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Tyre24\Common\Model\GetAvailableArticleTypesList400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 429:
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tyre24\Common\Model\GetAvailableArticleTypesList400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getLatestOrdersAsync
     *
     * Retrieve the latest orders.
     *
     * @param  string $country country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code). (required)
     ...
     * @return PromiseInterface
     */
    public function getLatestOrdersAsync(
        string $country,
        ?int $counter = null,
        ?bool $no_tagging = null,
        ?string $tracking_number = null,
    ...
    /**
     * Operation getLatestOrdersAsyncWithHttpInfo
     *
     * Retrieve the latest orders.
     *
     * @param  string $country country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code). (required)
     ...
     * @return PromiseInterface
     */
    public function getLatestOrdersAsyncWithHttpInfo(
        $country,
        $counter = null,
        $no_tagging = null,
    ...
    /**
     * Create request for operation 'getLatestOrders'
     *
     * @param  string $country country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code). (required)
     * @param  int|null $counter Default 0. Data records are combined by the interface into blocks that can be retrieved again. (optional)
     * @param  bool|null $no_tagging 0: the returned orders are set with the next available counter, if not previously retrieved, and marked with access time (the access time will not be changed by subsequent calls with no_tagging&#x3D;0); 1: the returned orders are set with the next available counter, if not previously retrieved, but no access time will be set. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getLatestOrdersRequest(
        $country,
        $counter = null,
        $no_tagging = null,
        $tracking_number = null,
    ...
    ): Request
    {
        ...
        if ($country === null || (is_array($country) && count($country) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $country when calling getLatestOrders'
            );
        }
        ...
        $resourcePath = '/common/latestorders';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getOrderDetailsByOrderId
     *
     * Get the details of a given order.
     *
     * @param  string $country country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code). (required)
     * @param  string $order order (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getOrderDetailsByOrderId'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \Tyre24\Common\Model\GetOrderDetailsByOrderId200Response|\Tyre24\Common\Model\GetAvailableArticleTypesList400Response|\Tyre24\Common\Model\GetAvailableArticleTypesList401Response
     */
    public function getOrderDetailsByOrderId(
        string $country,
        string $order,
        string $contentType = self::contentTypes['getOrderDetailsByOrderId'][0]
    ): \Tyre24\Common\Model\GetOrderDetailsByOrderId200Response
    {
    ...
    /**
     * Operation getOrderDetailsByOrderIdWithHttpInfo
     *
     * Get the details of a given order.
     *
     * @param  string $country country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code). (required)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Tyre24\Common\Model\GetOrderDetailsByOrderId200Response|\Tyre24\Common\Model\GetAvailableArticleTypesList400Response|\Tyre24\Common\Model\GetAvailableArticleTypesList401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderDetailsByOrderIdWithHttpInfo(
        string $country,
        string $order,
        string $contentType = self::contentTypes['getOrderDetailsByOrderId'][0]
    ): array
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\Tyre24\Common\Model\GetOrderDetailsByOrderId200Response', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Tyre24\Common\Model\GetOrderDetailsByOrderId200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Tyre24\Common\Model\GetOrderDetailsByOrderId200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
    ...
    /**
     * Operation getOrderDetailsByOrderIdAsync
     *
     * Get the details of a given order.
     *
     * @param  string $country country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code). (required)
     ...
     * @return PromiseInterface
     */
    public function getOrderDetailsByOrderIdAsync(
        string $country,
        string $order,
        string $contentType = self::contentTypes['getOrderDetailsByOrderId'][0]
    ): PromiseInterface
    ...
    /**
     * Operation getOrderDetailsByOrderIdAsyncWithHttpInfo
     *
     * Get the details of a given order.
     *
     * @param  string $country country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code). (required)
     ...
     * @return PromiseInterface
     */
    public function getOrderDetailsByOrderIdAsyncWithHttpInfo(
        $country,
        $order,
        string $contentType = self::contentTypes['getOrderDetailsByOrderId'][0]
    ): PromiseInterface
    ...
    /**
     * Create request for operation 'getOrderDetailsByOrderId'
     *
     * @param  string $country country code in ISO 3166-1 alpha-2 (lowercase 2-letter country code). (required)
     * @param  string $order (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getOrderDetailsByOrderId'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOrderDetailsByOrderIdRequest(
        $country,
        $order,
        string $contentType = self::contentTypes['getOrderDetailsByOrderId'][0]
    ): Request
    {
        ...
        if ($country === null || (is_array($country) && count($country) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $country when calling getOrderDetailsByOrderId'
            );
        }
        ...
        if ($order === null || (is_array($order) && count($order) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $order when calling getOrderDetailsByOrderId'
            );
        }


        $resourcePath = '/common/order/{order}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
