...
**buyer** | [**\Tyre24\Common\Model\BusinessPartnerLatest**](BusinessPartnerLatest.md) | All information of the buyer |
**seller** | [**\Tyre24\Common\Model\BusinessPartnerLatest**](BusinessPartnerLatest.md) | All information of the seller. Note: This property is only returned when logged in with a retailer account. | [optional]
**currency** | [**\Tyre24\Common\Model\Currency**](Currency.md) | Currency information for this order | [optional]
**shipping** | [**\Tyre24\Common\Model\Shipping**](Shipping.md) | All shipping information for this order |
**payment** | [**\Tyre24\Common\Model\Payment**](Payment.md) | All payment information for this order |
